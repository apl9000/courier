/**
 * Unit tests for Courier.send() method
...
Deno.test("Courier.send() - basic email with text", async () => {
...
Deno.test("Courier.send() - email with string recipient", async () => {
  const courier = await Courier.initialize(testConfig);
...
Deno.test("Courier.send() - email with object recipient (email + name)", async () => {
  const courier = await Courier.initialize(testConfig);
...
Deno.test("Courier.send() - email with array recipients", async () => {
  const courier = await Courier.initialize(testConfig);
...
Deno.test("Courier.send() - email with CC recipients", async () => {
  const courier = await Courier.initialize(testConfig);
...
Deno.test("Courier.send() - email with BCC recipients", async () => {
  const courier = await Courier.initialize(testConfig);
...
Deno.test("Courier.send() - email with replyTo", async () => {
  const courier = await Courier.initialize(testConfig);
...
Deno.test("Courier.send() - email with HTML content", async () => {
  const courier = await Courier.initialize(testConfig);
...
Deno.test("Courier.send() - returns SendResult object", async () => {
  const courier = await Courier.initialize(testConfig);

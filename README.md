...
- **Run individual integration tests:** Test specific email templates one at a time:
  ...
  deno test --allow-net --allow-read --allow-env  --env-file=.env tests/smtp.integration.spec.ts

  # Test individual email templates
  deno test --allow-net --allow-read --allow-env --env-file=.env tests/welcome-email.integration.spec.ts
  deno test --allow-net --allow-read --allow-env --env-file=.env tests/email-verification.integration.spec.ts
  deno test --allow-net --allow-read --allow-env --env-file=.env tests/password-reset.integration.spec.ts
  deno test --allow-net --allow-read --allow-env --env-file=.env tests/notification.integration.spec.ts
  deno test --allow-net --allow-read --allow-env --env-file=.env tests/newsletter.integration.spec.ts
  deno test --allow-net --allow-read --allow-env --env-file=.env tests/unsubscribe.integration.spec.ts
  ```
...
- **Template snapshots (optional):** To preview rendered HTML for built-in templates without sending
  email, run:
  ```zsh
  deno run --allow-read --allow-write scripts/render-template-snapshots.ts
  ```
